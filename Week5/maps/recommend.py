...
def find_closest(location, centroids):
    ...
    # BEGIN Question 3
    "*** YOUR CODE HERE ***"
    return min(centroids, key = lambda position: distance(location, position))
    # END Question 3
...
def group_by_centroid(restaurants, centroids):
    ...
    # BEGIN Question 4
    "*** YOUR CODE HERE ***"
    centroid_pairs = [[find_closest(restaurant_location(x), centroids), x] for x in restaurants]
...
def best_predictor(user, restaurants, feature_fns):
    ...
    # BEGIN Question 8
    "*** YOUR CODE HERE ***"
    return max([find_predictor(user, reviewed, f) for f in feature_fns], key = lambda pair: pair[1])[0]
    # END Question 8
