...
def is_swap(player_score, opponent_score):
    ...
    # BEGIN PROBLEM 4
    "*** YOUR CODE HERE ***"
    ones_1 = player_score % 10
    ones_2 = opponent_score % 10
    tens_1 = (player_score % 100) // 10
    tens_2 = (opponent_score % 100) // 10
    result = abs(tens_1 - ones_1) == abs(tens_2 - ones_2)
    return result
    # END PROBLEM 4
    ...
    def say(score0, score1):
        ...
        if who == 0:
            if score0 - previous_score > previous_high:
                new_previous_high = score0 - previous_score
                print(new_previous_high, "point(s)! That's the biggest gain yet for Player", who)
            new_previous_score = score0
        else:
            if score1 - previous_score > previous_high:
                new_previous_high = score1 - previous_score
                print(new_previous_high, "point(s)! That's the biggest gain yet for Player", who)
...
def make_averaged(fn, num_samples=1000):
    ...
    # BEGIN PROBLEM 8
    "*** YOUR CODE HERE ***"
    def averaged_value_of_cal_fn(*args):
        n = 0
        sum = 0
        while n < num_samples:
            sum += fn(*args)
    ...
    return averaged_value_of_cal_fn
    # END PROBLEM 8
...
def max_scoring_num_rolls(dice=six_sided, num_samples=1000):
    ...
    max_score = 0
    num_rolls = 1
    evaluate_fn = make_averaged(roll_dice, num_samples)
    while num_rolls < 11:
        score = evaluate_fn(num_rolls, dice)
        if score > max_score:
            max_score = score
            optimal_num_rolls = num_rolls
        num_rolls += 1
